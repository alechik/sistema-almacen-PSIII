...
<main class="app-main">
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Nueva Unidad de Medida</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('unidad-medidas.index') }}">Unidad de Medida</a></li>
                    ...
                    <form action="{{ route('unidad-medidas.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('cod_unidad_medida') }}"
                                   placeholder="Ej: KG, LT, MTS">
