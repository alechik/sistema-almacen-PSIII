...
<main class="app-main">
    ...
    <div class="app-content-header">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <h3 class="mb-0">Editar Salida</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                    value="{{ $salida->codigo_comprobante }}" readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label class="form-label fw-bold">Nota Venta</label>
                                <input type="text" class="form-control"
                                    value="{{ $salida->nota_venta_id }}" readonly>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="punto_venta_id" class="form-select">
                                    ...
                                    @foreach($puntosVenta as $pv)
                                        <option value="{{ $pv['id'] }}"
                                            {{ $salida->punto_venta_id == $pv['id'] ? 'selected' : '' }}>
                                            {{ $pv['nombre'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="almacen_id">
                                    ...
                                    <option value="{{ $a->id }}"
                                        {{ $salida->almacen_id == $a->id ? 'selected' : '' }}>
                                        {{ $a->nombre }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="operador_id">
                                    @foreach($operadores as $o)
                                        <option value="{{ $o->id }}"
                                            {{ $salida->operador_id == $o->id ? 'selected' : '' }}>
                                            {{ $o->full_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="transportista_id">
                                    @foreach($transportistas as $t)
                                        <option value="{{ $t->id }}"
                                            {{ $salida->transportista_id == $t->id ? 'selected' : '' }}>
                                            {{ $t->full_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="vehiculo_id">
                                    @foreach($vehiculos as $v)
                                        <option value="{{ $v->id }}"
                                            {{ $salida->vehiculo_id == $v->id ? 'selected' : '' }}>
                                            {{ $v->placa_identificacion }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="tipo_salida_id" class="form-select">
                                    @foreach($tiposSalida as $ts)
                                        <option value="{{ $ts->id }}"
                                            {{ $salida->tipo_salida_id == $ts->id ? 'selected' : '' }}>
                                            {{ $ts->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-bordered mb-0" id="detalleTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <select name="detalles[{{ $i }}][producto_id]" class="form-select">
                                    ...
                                    <td>
                                        <input type="number" class="form-control cantidad"
                                            name="detalles[{{ $i }}][cant_salida]"
                                            value="{{ $d->cant_salida }}" step="0.01" min="0.01">
                                    </td>

                                    <td>
                                        <input type="number" class="form-control precio"
                                            name="detalles[{{ $i }}][precio]"
                                            value="{{ $d->precio }}" step="0.0001" min="0.0001">
                                    </td>

                                    <td class="subtotal">
                                        {{ number_format($d->cant_salida * $d->precio, 2) }}
                                    </td>
...
let index = {{ count($salida->detalles) }};
