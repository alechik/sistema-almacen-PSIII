...
<main class="app-main">
    ...
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Asignar Producto a Almacén</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('almacen-productos.index') }}">
                            Almacén - Productos
                        </a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Asignar Producto</h3>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="en_pedido"
                                    ...
                                    <option value="">Seleccione...</option>
                                    <option value="0" {{ old('en_pedido') == "0" ? 'selected' : '' }}>
                                        No
                                    </option>
                                    <option value="1" {{ old('en_pedido') == "1" ? 'selected' : '' }}>
                                        Sí
                                    </option>
                                </select>
                                @error('en_pedido')
