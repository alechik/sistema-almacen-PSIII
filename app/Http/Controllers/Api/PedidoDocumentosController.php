...
class PedidoDocumentosController extends Controller
{
     ...
     */
    public function recibirDocumentos(Request $request, Pedido $pedido)
    {
        try {
            Log::info('📄 [PedidoDocumentosController] Recibiendo documentos de entrega', [
                'pedido_id' => $pedido->id,
            ...
            // Actualizar estado del pedido a "entregado" si no lo está
